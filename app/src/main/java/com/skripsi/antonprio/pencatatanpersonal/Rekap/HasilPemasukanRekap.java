...
import com.skripsi.antonprio.pencatatanpersonal.Adapter.RekapPemasukanAdapter;
 ...
 */
public class HasilPemasukanRekap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rekap_pemasukan);
        labelJudulDari = (TextView) findViewById(R.id.rp_label_judul_rekap);
        labelJudulSampai = (TextView) findViewById(R.id.rp_label_judul_rekap2);
        labelTotal = (TextView) findViewById(R.id.rp_label_total_rekap);
        ...
        labelJudulDari.setText("Hasil Rekap Pemasukan Dari "+dari);
        ...
        recyclerView = (RecyclerView) findViewById(R.id.rp_rview_hasil_rekap);
        RecyclerView.Adapter adapter = new RekapPemasukanAdapter(service.getPemasukanRekap(dari, sampai));
